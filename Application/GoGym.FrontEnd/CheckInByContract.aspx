<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="CheckInByContract.aspx.cs" Inherits="GoGym.FrontEnd.CheckInByContract" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphMainTitle" runat="server">
    Check-in by Contract
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <div style="text-align: center; width: 600px; float: left; margin-right: 10px;">
        <fieldset style="height: 450px;">
            <legend id="branchName"></legend>

            <telerik:RadTextBox ID="txtBarcode" Font-Size="300%" runat="server" Height="80px" Width="500px" />
            <asp:HyperLink ID="hypLookUpCustomer" NavigateUrl="#" runat="server">Look Up</asp:HyperLink>
            <asp:Button ID="btnDummy" runat="server" Text="Dummy" style="display:none;" OnClientClick="btnDummy_Click" />
    ...
    <script>
        ...
        function formSubmit() {
            ...
            checkInService.DoCheckInByContract(branchID, barcode, userName, checkInSuccess, checkInFailed);
        ...
        function checkInSuccess(data) {
            ...
            if (data.CustomerBarcode != null) {
                result = "<h1>" + data.ContractNo + "</h1><h1>" + data.CustomerBarcode + "</h1>" +
            ...
            checkInService.GetCheckInHistory(branchID, function (historyList) {
                ...
                if (historyList != null) {
                    for (var index = 0; index < historyList.length; index++) {
                        ...
                        var row = "<tr><td>"+ historyList[index].ContractNo +"</td><td>" + historyList[index].CustomerBarcode + "</td><td>" + historyList[index].CustomerName + "</td><td>" + when + "</td>" +
