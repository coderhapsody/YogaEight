<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="ReportDetailInstructor.aspx.cs" Inherits="GoGym.FrontEnd.Reports.ReportDetailInstructor" StyleSheetTheme="Workspace"%>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphMainContent" Runat="Server">
    <table>
        ...
        <tr>
            ...
            <td class="style2">&nbsp;</td>
            <td>
                <telerik:RadButton ID="btnViewReport" runat="server" Text="View Report" EnableViewState="false" />
            </td>
        </tr>
    </table>
