<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="MasterArea.aspx.cs" Inherits="GoGym.FrontEnd.MasterArea" StylesheetTheme="Workspace" %>
                ...
                <tr>
                    <td>
                        ...
                        <asp:SqlDataSource ID="sdsMaster" runat="server"
                            ...
                            SelectCommand="proc_GetAllAreas" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                    </td>
                </tr>
            </table>
        </asp:View>
            ...
            <table class="style1">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rqvDescription" EnableClientScript="true" runat="server" ControlToValidate="txtDescription" EnableViewState="false" ErrorMessage="<b>Description</b> must be specified" ValidationGroup="AddEdit" CssClass="errorMessage" SetFocusOnError="true" />
                    </td>
                </tr>
                <tr>
                    <td class="style2">&nbsp;</td>
