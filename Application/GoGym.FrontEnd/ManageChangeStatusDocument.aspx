<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="ManageChangeStatusDocument.aspx.cs" Inherits="GoGym.FrontEnd.ManageChangeStatusDocument" StyleSheetTheme="Workspace" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphMainContent" runat="Server">
                    ...
                    <td>
                        <table class="ui-accordion">
                            ...
                            <tr>
                                ...
                                <td class="style4">:</td>
                                <td>
                                    <telerik:RadDropDownList ID="ddlFindDocumentType" runat="server" Width="120px"/>                                    
                                </td>
                            </tr>
                            <tr>
        ...
        <asp:View ID="viwAddEdit" runat="server">
            <table class="ui-accordion">
                ...
                <tr>
                    ...
                    <td class="style2">:</td>
                    <td>
                        <telerik:RadDropDownList ID="ddlDocumentType" runat="server" />                        
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="style2">:</td>
                    <td>
                        <telerik:RadTextBox ID="txtCustomerCode" runat="server" CssClass="textbox" MaxLength="50"
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtNotes" runat="server" Columns="80" MaxLength="50" Rows="8" TextMode="MultiLine" ValidationGroup="AddEdit" />
                        <br />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <telerik:RadButton ID="btnCancel" runat="server" CausesValidation="false"
                            EnableViewState="false" OnClick="btnCancel_Click" Text="Cancel"
                        ...
                        <telerik:RadButton ID="btnApprove" runat="server" 
                            ...
                            ValidationGroup="AddEdit" />
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                        <telerik:RadButton ID="btnVoid" runat="server" CausesValidation="false" Visible="false"
                            EnableViewState="false" OnClick="btnVoid_Click" Text="Void"
                            OnClientClicking="VoidConfirm"
                            ValidationGroup="AddEdit" />
                    </td>
                </tr>
            </table>
    ...
    <script language="javascript" type="text/javascript">
        function ValidateCustomerCode(source, arg) {
            arg.IsValid = $find('<%= txtCustomerCode.ClientID %>').get_value() != "";
        }
