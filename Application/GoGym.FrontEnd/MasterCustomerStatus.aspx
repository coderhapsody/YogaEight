<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="MasterCustomerStatus.aspx.cs" Inherits="GoGym.FrontEnd.MasterCustomerStatus"  StyleSheetTheme="Workspace" %>
            ...
            <table class="style1">
                ...
                <tr>
                    ...
                    <td class="style3">
                        :</td>
                    <td>
                        Foreground: <telerik:RadColorPicker ID="colColor" runat="server" ShowIcon="True" />                        
                        Background: <telerik:RadColorPicker ID="colBgColor" runat="server"  ShowIcon="True" />
                    </td>                    
                </tr>
                <tr>
                    <td class="style2">
