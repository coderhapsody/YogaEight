<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPrompt.Master" AutoEventWireup="true" CodeBehind="PromptContractCheckIn.aspx.cs" Inherits="GoGym.FrontEnd.PromptContractCheckIn"  StyleSheetTheme="Workspace"%>
            ...
            <td>
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadTextBox runat="server" ID="txtContractNo"></telerik:RadTextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadTextBox runat="server" ID="txtCustomerName"></telerik:RadTextBox>
        ...
        <tr>
            <td>
                ...
                <asp:SqlDataSource ID="sdsPrompt" runat="server" ConnectionString="<%$ ConnectionStrings:FitnessConnectionString %>"
                    SelectCommand="proc_GetAllContracts" SelectCommandType="StoredProcedure" OnSelecting="sdsPrompt_Selecting">
                    <SelectParameters>
